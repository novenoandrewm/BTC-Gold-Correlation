...
This repository contains all files investigating the statistical relationship between Bitcoin (BTC) prices and Gold prices.
...
4. **04_merge_align.ipynb** — Merge Gold & BTC, ensure matching months.
